...
const smsDia = () => { return `🌇 Buenos Días Humanos/Humanas ⛅`}
const smsTarde = () => { return `🏙️ Buenas Tardes Personitas 🌤️`}
const smsTarde2 = () => { return `🌆 Buenas tardes Linduris 🌥️`}
const smsNoche = () => { return `🌃 Buenas noches Descansen 💫`}
const smsListaMenu = () => { return `⊹ LISTA DE MENU ⊹`}
const smsLista1 = () => { return `🌟 INFORMACIÓN DE Kuromi-Bot-CS 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR Kuromi-Bot-CS 🐈`}
...
const smsSpromote = () => { return '*@user 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊 𝐃𝐈𝐒𝐅𝐑𝐔𝐓𝐀𝐋𝐎!!*'}
const smsSdemote = () => { return '*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊 𝑻𝑬 𝑳𝑶 𝑷𝑰𝑬𝑹𝑫𝑬𝑺!!*'}
...
const smsCodigoQR = () => { return `\n✅ ESCANEA EL CÓDIGO QR EXPIRA EN 40 SEGUNDOS ✅`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝗦𝘂𝗽𝗲𝗿 𝐊𝐮𝐫𝐨𝐦𝐢𝗕𝗼𝘁-𝐂𝐒 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsToxic7 = () => { return `𝙎𝙐𝙋𝙀𝙍𝘼𝙎𝙏𝙀 𝙇𝘼𝙎 3 𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼𝙎 𝘼𝙃𝙊𝙍𝘼 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼) 🙄`}
...
const eGataCoins = () => { return '🐱 KuromiCoins' }
const eGataTickers = () => { return '🎫 Kitty Tickets' } 
...
//_antiviewonce.js
const smsAntiView = () => { return `*𝙈𝘼𝙎𝙏𝙀𝙍 𝑷𝑨𝑹𝑨 𝑴𝑰 𝑵𝑶 𝑯𝑨𝒀 𝑺𝑬𝑪𝑹𝑬𝑻𝑶𝑺* 😎`} 
...
const smskick2 = () => { return `ELIMINADO(A) POR BOT 😼🫵`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝑲𝒖𝒓𝒐𝒎𝒊-𝑩𝒐𝒕-𝑪𝑺!!! 😸\n\n💖 𝑲𝒖𝒓𝒐𝒎𝒊-𝑩𝒐𝒕-𝑪𝑺 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
